...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference("Comentario.count") do
      post comentarios_url, params: { comentario: { aprovado: @comentario.aprovado, conteudo: @comentario.conteudo, filme_id: @comentario.filme_id } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { aprovado: @comentario.aprovado, conteudo: @comentario.conteudo, filme_id: @comentario.filme_id } }
